# CardioLink Admin v4.0.9.1 — Estabilización de Historia Clínica
...
## Importar evoluciones históricas desde Medicloud (v4.0.9.1)
...
## Documentos profesionales (v4.0.9.1)
...
## v4.0.9.1 — búsqueda y panel de evolución
