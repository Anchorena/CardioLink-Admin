# CardioLink Admin v4.0.9.4 — Estabilización de Historia Clínica
...
## Importar evoluciones históricas desde otra app (v4.0.9.4)
...
## Documentos profesionales (v4.0.9.4)
...
## v4.0.9.4 — búsqueda y panel de evolución
...
## Flujo de consulta y documentos rápidos (v4.0.9.4)
...
## Dictado clínico por campo (v4.0.9.4)
